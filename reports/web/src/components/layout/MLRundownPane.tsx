  ...
  if (!isOpen) {
    return (
      <button
        ...
        title="Open ML Intelligence & Decision Pane"
        ...
        {loading || !rundown ? (
          ...
          <>
            ...
            <div className="bg-[#121622] p-2.5 rounded border border-[#1E2638] text-[11px] text-gray-300">
              ...
              These 5 items rank the strongest signals driving the machine learning model today. Each item breaks down the mathematical output into plain English and gives you an actionable quant playbook.
            </div>
